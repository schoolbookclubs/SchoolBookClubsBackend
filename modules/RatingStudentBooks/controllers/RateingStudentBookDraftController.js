import RateingStudentBookDraft from "../../../models/RateingStudentBookDraft.js";
...
class RateingStudentBookDraftController {
  ...
  static async getBookRatings(req, res) {
    try {
      ...
      const ratings = await RateingStudentBookDraft.find({ bookId })
  ...
  static async getStudentBookRating(req, res) {
    try {
      ...
      const rating = await RateingStudentBookDraft.find({ studentId, bookId });
  ...
  static async getRatingsBySchoolCode(req, res) {
    try {
      ...
      const ratings = await RateingStudentBookDraft.find({ schoolCode })
        .populate('studentId', 'name')
 ...
 static async getUniqueRatedBooksCount(req, res) {
  try {
    ...
    const uniqueBooks = await RateingStudentBookDraft.distinct('bookId', { 
      schoolCode,
    ...
    const booksWithDetails = await RateingStudentBookDraft.find({
      schoolCode,
  ...
  static async getStudentRatingsWithDetails(req, res) {
    try {
      ...
      const ratings = await RateingStudentBookDraft.find({ studentId })
...
export default RateingStudentBookDraftController;
